...
class TestDelinquencyLevels:
    ...
    def test_enum_values(self):
        ...
        # Updated to match actual enum values in historical_penalty.py
        assert DelinquencyLevel.NONE.value == "clean"
        assert DelinquencyLevel.SHORT_TERM.value == "leve"
        assert DelinquencyLevel.LONG_TERM.value == "moderado"
        assert DelinquencyLevel.SEVERE.value == "severo"
        assert DelinquencyLevel.DEFAULT.value == "critico"
