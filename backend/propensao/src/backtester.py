...
class Backtester:
    ...
    def exportar_relatorio_markdown(
        ...
        lines = [
            ...
            "## Sumário",
            "",
            f"**Status demonstrativo: {'critérios internos atendidos' if resultado.passou_validacao else 'critérios internos não atendidos'}**",
            "**Origem:** dados sintéticos; este resultado não aprova o modelo para uso institucional.",
            "",
            resultado.detalhes,
            "",
            "## Métricas Agregadas",
