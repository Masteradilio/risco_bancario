...
| Repudiation | negar execução ou operação crítica | sessão identificada e confirmação de uso único persistida; trilha completa de ações será ampliada na Tarefa 14.4 | logs HTTP completos ainda não concluídos |
