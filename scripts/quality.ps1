...
$Targets = @("src", "tests/domain", "tests/configuration", "tests/regulatory", "tests/data", "tests/models", "tests/application", "tests/validation", "scripts/generate_pd_backtest_report.py", "scripts/generate_lgd_backtest_report.py", "scripts/generate_ead_backtest_report.py", "scripts/generate_ecl_backtest_report.py")
